...
import { removeItemFromCart, clearCart, increaseItemQuantity, decreaseItemQuantity,enableProduct  } from './CartSlice'; // Assuming you have action creators for increasing and decreasing item quantity
